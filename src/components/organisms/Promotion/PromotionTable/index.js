...
const TableRowModule = ({ promotionName, startDate, endDate, percent, listProductId, promotionCodes, promotionDetails, status }) => (
    <>
        ...
        <TableCell>{listProductId}</TableCell>
        <TableCell>{promotionCodes}</TableCell>
        <TableCell>{promotionDetails}</TableCell>
        <TableCell>
