...
import { doMultipleExecute } from '../../../../redux/reducers/userGroupReducer';
...
const UserGroupAction = () => {
    const selector = useSelector(({ 
        userGroupReducer: { multipleExecuteLoading, checkedItems } }) => ({ multipleExecuteLoading, checkedItems })
    , shallowEqual)
