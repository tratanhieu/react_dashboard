...
import { doMultipleExecute } from '../../../../redux/reducers/producerCategoryReducer';
...
const ProducerAction = () => {
    ...
    //     ProducerCategoryReducer: { multipleExecuteLoading, checkedItems } }) => ({ multipleExecuteLoading, checkedItems })
    // , shallowEqual)
