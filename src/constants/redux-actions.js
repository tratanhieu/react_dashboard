...
export const REDUX_SEARCH = 'SEARCH'
export const REDUX_FILTER_BY_STATUS = 'FILTER_BY_STATUS'
export const REDUX_SORT = 'SORT'
...
export const REDUX_MODAL_SAVE_SUCCESS = 'MODAL_SAVE_SUCCESS'